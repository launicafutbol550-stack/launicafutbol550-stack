...
function App() {
  ...
  const [authLoginData, setAuthLoginData] = useState(emptyLogin);
  ...
  const loginUser = async (event) => {
    ...
    try {
      await signInWithEmailAndPassword(auth, authLoginData.email, authLoginData.password);
      setAuthLoginData(emptyLogin);
      ...
      <main>
        ...
        {!loading && activeSection === 'registro' && (
          <AuthPage
            ...
            onChangeLogin={(field, value) => setAuthLoginData((prev) => ({ ...prev, [field]: value }))}
